...
**Figure 2 Takeaways:** This graph is a good representation of the changes un actual urchin population. One must take into account the sample size of the population. In this case n=31805 for purple urchins.Based on this large sample size it is fair to say that the data may be representative of the actual population. One must also take into account the treatments in the study, which includes a control group with giant kelp left intact and an annual group with giant kelp removed once each winter and allowed to re-colonize over the year. These different treatments were not taken into account in the data visualization in figure 2. Other factors that need to be taken into account and could have impacts on urchin population include, water temperature, and water nutrient levels.